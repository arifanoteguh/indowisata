   ...
   ?>
    ...
    <div class="col-sm-8">
      ...
      <div class="form-group has-feedback">
        <label class="control-label col-sm-2 text-right" > Tanggal lahir (YYYY/MM/DD) </label>
        <div class="col-sm-3">
            <select class="form-control" name="tanggal" id="tanggal">
              ...
              if($tgl!=%tgll){
                ...
                <option selected value="<?php echo $tgl ?>"><?php echo $tgl ?></option>  
              }
              <?php
              $tgll=$tgll+1;
              }
              ...
              if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){ 
                if($ukuran_file<=20000000){
                  if(move_uploaded_file($tmp_file,$target_file)){
                    $update = "update user set nama='$name', email='$email', tgl_lahir='$tgl_lahir', nama_foto='$nama_file', size_foto='$ukuran_file', tipe_foto='$tipe_file' where username='$user'";
                ...
                $update = "update user set nama='$name', email='$email', tgl_lahir='$tgl_lahir' where username='$user'";
