		...
		<div class="col-sm-10" style="margin-top:5%; margin-left:8%;">
			<ul class="list-group" >
				<li class="list-group-item" style="padding:1%">	
						<div class="panel-heading" style="background-color:#3a3a3a; border-color:#e32929">Foto Member</div>
						<center> <div class="panel-body"><img src="../../img/logo2.png" class="img-responsive" alt="Image"></div> </center>
				</li>
				<li class="list-group-item"  style="padding:1%">	
				<div class="panel-heading" style="background-color:#3a3a3a; border-color:#e32929">Info Member</div>
						<table class="table" style="color:black">
							<tbody>
								<tr>
								 <td class="col-sm-3">  ID POST </td> 
