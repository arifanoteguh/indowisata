...
<!--end-->
		       ...
		       <div class="panel-heading"><h4> Admin <br> </h4> <h6> Ubah pengaturan Akun Admin. </h6></div>
		        ...
		        <form method="post" enctype="multipart/form-data" name="formakun">	        
		          ...
		          <div class="form-group">
		              ...
		              <div class="col-sm-9">
		               <input type="id" class="form-control" name="id" value="<?php echo $admin_id;?>"  disabled>
		              </div> <br><br>
		          </div>    
		          <div class="form-group">
		              <label class="control-label col-sm-3 text-right" style="margin-top:5px;" for="namaadmin"> Nama </label>
		              <div class="col-sm-9">
		                <input type="nama" class="form-control" name="nama" value="<?php echo $nama;?>"/>
		              </div> <br><br>
		          </div>
		          <div class="form-group">
		              <label class="control-label col-sm-3 text-right" style="margin-top:5px;" for="namakota"> Username </label>
		              <div class="col-sm-9">
	...
	<?php
          if(isset($_POST['update'])){
            ...
            $update = "update kota set nama='$namaadmin', username='$usernameadmin' where id_kota='$id'";
