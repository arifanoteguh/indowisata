	...
	<div class="col-sm-2" style="float:left; background-color: #3a3a3a; text-align:center; padding:0; height:100%; position:fixed; z-index:999;">  
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<a class="menu active"  href="#"><li>Data Member <span class="glyphicon glyphicon-pencil" style="float:right;"></span></li></a>
			...
			<div class="col-sm-12" style="color:#3a3a3a">
				...
				<table id="MyTable" class="table table-hover table-bordered results">
				  <thead>
				    <tr>
				      <th>ID</th>
				      <th class="col-md-3 col-xs-3">Foto</th>
				     
				      <th class="col-md-3 col-xs-3">Username</th>
				      <th class="col-md-2 col-xs-2">Email</th>
				      <th class="col-md-2 col-xs-2">Tanggal Lahir</th>
					...
					?>
					    <tr>
					      ...
					      <td>
					      	  	<form action="../admin/ubah/member.php" method="get">
							...
							<td>
								<form action="../admin/lihat/member.php" method="get">
							      	<input type="hidden" name="id" value="<?php echo $row['id_user']?>">
									<center> 
										<button type="submit" style="background:none; border:none;padding:0;">
							...
							<td>
								<form action="../admin/hapus/member.php" method="get">
									<center> 
										<button type="button" style="background:none; border:none;padding:0;" onclick="hapus(<?php echo $row['id_user']?>)" name="hapususer"> 
								...
								<script language="javascript">
									function hapus(hapusid){
										if(confirm("Apakah kamu mau hapus ?")){
											window.location.href='../admin/hapus/member.php?hapus_id=' +hapusid+ '';
											return true;
										}
									}
