	...
	<div class="col-sm-2" style="float:left; background-color: #3a3a3a; text-align:center; padding:0; height:100%; position:fixed; z-index:999;">   
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<a class="menu active" href="#"><li>Data Post <span class="glyphicon glyphicon-pencil" style="float:right;"></span></li></a>
				...
				<table class="table table-hover table-bordered results">
				  <thead>
				    <tr>
				      ...
				      <th class="col-md-2 col-xs-2">Alamat</th>
				      <th class="col-md-2 col-xs-2">Caption</th>
					...
					<?php
						...
						$query=mysqli_query($konek,"SELECT * FROM post JOIN user ON post.id_user=user.id_user order by id_post asc");
						if(!$query){
					...
					?>
					    <tr>
					      ...
					      <td><img src="<?php echo $foto ?>" style="width:100%;"></td>
					      <td><?php echo $row['username'] ?></td>
					      <td><?php echo $row['alamat'] ?></td>
					      <td><?php echo potong_caption($row['caption'],47) ?></td>
					      <td>
							  	<form action="../admin/ubah/post.php" method="get">
							...
							<td>
								<form action="../admin/lihat/post.php" method="get">
							      	<input type="hidden" name="id" value="<?php echo $row['id_post']?>">
									<center> 
										<button type="submit" style="background:none; border:none;padding:0;">
							...
							<td>
								<form action="../admin/hapus/member.php" method="get">
									<center> 
										<button type="button" style="background:none; border:none;padding:0;" onclick="hapus(<?php echo $row['id_post']?>)" name="hapuspost"> 
								...
								<script language="javascript">
									function hapus(hapusid){
										if(confirm("Apakah kamu mau hapus ?")){
											window.location.href='../admin/hapus/post.php?hapus_id=' +hapusid+ '';
											return true;
										}
									}
								</script>
