	...
	<div class="col-sm-2" style="float:left; background-color: #3a3a3a; text-align:center; padding:0; height:100%; position:fixed; z-index:999;">  
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<a class="menu active" href="#"><li>Data Provinsi <span class="glyphicon glyphicon-pencil" style="float:right;"></span></li></a>
			...
			<div class="col-sm-12" style="color:#3a3a3a">
				...
				<table id="MyTable" class="table table-hover table-bordered results">
				  <thead>
				    <tr>
				      <th>ID</th>
				      <th class="col-md-5 col-xs-5">Provinsi</th>
					...
					<?php
						...
						$query=mysqli_query($konek,"SELECT * FROM provinsi order by id_prov asc");
						if(!$query){
					...
					?>
					    <tr>
					      <th scope="row"><?php echo $row['id_prov'] ?></th>
					      <td><?php echo $row['provinsi'] ?></td>
					      <td>
								<form action="../admin/ubah/prov.php" method="get">
							...
							<td>
								<center> 
									<button type="button" style="background:none; border:none;padding:0;" onclick="hapus(<?php echo $row['id_prov']?>)"> 
								...
								<script language="javascript">
									function hapus(hapusid){
										if(confirm("Apakah kamu mau hapus ?")){
											window.location.href='../admin/hapus/provinsi.php?hapus_id=' +hapusid+ '';
											return true;
										}
									}
								</script>
